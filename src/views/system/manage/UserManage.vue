<template>
  <div class="userManageContent">
      ...
      <div class="dataContent">
          ...
          <el-form :inline="true" class="demo-form-inline">
            ...
            <el-form-item label="角色:">
              <el-select v-model="searchParams.role">
                ...
                <el-option v-for="(item,index) in roleTypeList" :key="index" :label="item" :value="index+1"></el-option>
              </el-select>
            </el-form-item>
            <el-form-item>
        ...
        <div class="dataListArea">
          <el-table row-class-name="trStyle" class="tableData" :data="tableData" border stripe width="100%">
            ...
            <el-table-column align="center" :show-overflow-tooltip="true" label="角色" >
              <template slot-scope="scope">
                {{roleTypeList[scope.row.role-1]}}
              </template>
            </el-table-column>
            <el-table-column align="center" label="操作" width="500px" fixed="right">
              <template slot-scope="scope">
                ...
                <el-button type="primary" v-if="scope.row.role==1" size="mini" @click="showBind(scope.row)">绑定客户</el-button>
    ...
    <div>
      <el-drawer size="50%" title="员工详情" :visible.sync="drawer" direction="rtl" :before-close="closeCheckDrawer">
          ...
          <el-form>
            ...
            <el-row>
              ...
              <el-col :span="12">
                <el-form label-width="100px">
                  <el-form-item label="角色:">
                    <label>{{roleTypeList[detailInfo.role-1]}}</label>
                  </el-form-item>
                </el-form>
              </el-col>
            </el-row>
    ...
    <div>
      <el-drawer size="50%" :title="drawerTitle" :visible.sync="updateDrawer"  direction="rtl" :before-close="closeCheckDrawer">
        <div class="checkDrawer">
          <el-divider content-position="left"></el-divider>
          <el-form :model="detailInfo" ref="userForm" :rules="rules" label-width="100px">
            <el-row>
              ...
              <el-col :span="operateType=='update'?11:12" :offset="operateType=='update'?1:0">
                <el-form-item label="账号:" prop="account">
                  <label  v-if="operateType=='update'">{{detailInfo.account}}</label>
                  <el-input v-else v-model="detailInfo.account" type="text" placeholder="请输入账号" ></el-input>
                </el-form-item>
              </el-col>
            </el-row>
            <el-row>
              <el-col :span="12">
                <el-form-item label="姓名:"  prop="name">
                  <el-input v-model="detailInfo.name" type="text" placeholder="请输入姓名"></el-input>
                </el-form-item>
              </el-col>
              <el-col :span="11" :offset="1">
                <el-form-item label="角色:">
          ...
          <el-col :span="11">
            ...
            <div class="searchArea">
              <div class="searchForm">
                <el-form :inline="true" class="demo-form-inline">
                  <el-form-item label="关键字:">
                    <el-input v-model="bindSearchParamsKey" placeholder="请输入姓名或账号"></el-input>
                  </el-form-item>
                  <el-form-item>
                    <el-button plain @click="getBindedCustomer">搜&nbsp;&nbsp;索</el-button>
                  </el-form-item>
                </el-form>
              </div>
            </div>
            <el-table row-class-name="trStyle" class="tableData" :data="bindedCustomerList" border stripe width="100%">
              <el-table-column align="center" :show-overflow-tooltip="true" prop="id" label="编号" >
              </el-table-column>
              <el-table-column align="center" :show-overflow-tooltip="true" prop="companyName" label="公司">
              </el-table-column>
              <el-table-column align="center" :show-overflow-tooltip="true" prop="address" label="地址">
              </el-table-column>
              <el-table-column align="center" :show-overflow-tooltip="true" prop="contacts" label="联系人">
              </el-table-column>
          ...
          <el-col :span="11" :offset="1">
            ...
            <div class="searchArea">
              <div class="searchForm">
                <el-form :inline="true" class="demo-form-inline">
                  <el-form-item label="关键字:">
                    <el-input v-model="unbindSearchParamsKey" placeholder="请输入姓名或账号"></el-input>
                  </el-form-item>
                  <el-form-item>
                    <el-button plain @click="getCustomerList">搜&nbsp;&nbsp;索</el-button>
                  </el-form-item>
                </el-form>
              </div>
            </div>
            <el-table row-class-name="trStyle" class="tableData" :data="customerList" border stripe width="100%">
              <el-table-column align="center" :show-overflow-tooltip="true" prop="id" label="编号" >
              </el-table-column>
              <el-table-column align="center" :show-overflow-tooltip="true" prop="companyName" label="公司">
              </el-table-column>
    ...
    data() {
      return {
        ...
        searchParams: {
          //关键字：姓名/账号
          key: "",
          //角色:0客户1业务员2厂长3仓库管理员4打印组长5打印员6检验员
          role: ""
        },
        ...
        roleTypeList:['业务员','厂长','仓库管理员','打印组长','打印员','检验员','调色员'],
        drawerTitle:'新增用户',
        updateDrawer:false,
        //编辑类型：add,update
        operateType:'add',
