        ...
        <div class="searchArea">
          ...
          <el-form :inline="true" class="demo-form-inline">
            <el-form-item label="关键字:" width="400px">
              <el-input v-model="searchParams.key" placeholder="公司名/联系人/联系电话/规格"></el-input>
            </el-form-item>
            ...
            <el-row>
              <el-form label-width="100px">
                <el-form-item label="花型:">
                  <el-col style="overflower:hidden;" :span="4" :offset="1" v-for="(item,index) in detailInfo.orderDetails" :key="index">
                    <img style="width: 100%;" :src="baseUrl+item.flowerUrl"/>
                    <div style="width: 100%;text-align: center;line-height: 0px;">{{item.flowerNum}}</div>
                  </el-col>
                </el-form-item>
              </el-form>
            </el-row>
