    ...
    <div class="content">
      <div class="search">
        <el-form :inline="true" ref="searchForm">
          ...
          <el-form-item label="操作:">
            <el-select v-model="searchParams.status" placeholder="请输入操作状态" clearable>
              <el-option
      ...
      <div class="table">
        <el-table :data="tableData" border stripe width="100%">
          <el-table-column align="center" :show-overflow-tooltip="true" prop="createTime" label="操作时间" >
          </el-table-column>
          <el-table-column align="center" :show-overflow-tooltip="true" prop="createByName" label="操作者" >
          </el-table-column>
          <el-table-column align="center" :show-overflow-tooltip="true" prop="customerName" label="客户" >
          </el-table-column>
          <el-table-column align="center" :show-overflow-tooltip="true" prop="fabricName" label="面料" >
          </el-table-column>
          <el-table-column align="center" :show-overflow-tooltip="true" label="操作状态" >
        ...
        <el-pagination background layout="prev, pager, next" @current-change="changePage" :total="page.total" :current-page.sync="page.page">
        </el-pagination>
      </div>
      <div>
  ...
  methods: {
    ...
    exportExcel(list) {
      require.ensure([], () => {
        ...
        const tHeader = ["操作时间", "操作者", "客户", '面料','库存操作状态(0:上浆,1:产生生成流通,2:清除生成流通,3:检验,4:出库,5：手动强制修改库存)',
        '原来未漂仓米数','现未漂仓米数','原来未漂匹','现未漂匹','原来上浆仓','现上浆仓','原来生产流通量','现生产流通量','原来成品仓','现成品仓','备注'];
        // 上面设置Excel的表格第一行的标题
        const filterVal = ["createTime", "createByName", "customerName",'fabricName','status','snum1','nnum1','srollNum','nrollNum','snum2',
        'nnum2','snum4','nnum4','snum3','nnum3','note'];
