      ...
      <div class="dataContent">
        ...
        <div class="dataListArea">
          <el-table row-class-name="trStyle" class="tableData" :data="tableData" border stripe width="100%">
            ...
            <el-table-column align="center" :show-overflow-tooltip="true" prop="customerName" label="客户名称">
            </el-table-column>
            <el-table-column align="center" :show-overflow-tooltip="true" prop="percent" label="缩水比例">
            </el-table-column>
            <el-table-column align="center" :show-overflow-tooltip="true" prop="threshold" label="警报阀值">
            </el-table-column>
