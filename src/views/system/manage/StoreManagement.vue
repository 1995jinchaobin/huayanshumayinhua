          ...
          <div class="searchForm">
            <el-tabs v-model="activeName" type="card" @tab-click="handleClick">
              <el-tab-pane label="库存信息" name="StockInfo">
                <Stock-info :companyList="companyList" :regionlist="regionlist"></Stock-info>
              </el-tab-pane>
              <el-tab-pane label="入库" name="InboundList">
                <InboundList :companyList="companyList" :regionlist="regionlist"></InboundList>
              </el-tab-pane>
              <el-tab-pane label="出库" name="OutboundList">
                <OutboundList :companyList="companyList" :regionlist="regionlist"></OutboundList>
              </el-tab-pane>
            </el-tabs>
