          ...
          <el-col class="itemEchart">
            <div class="sellCountContentTitle">
              <div class="titleBox">
                <span>下单与出货米数</span>
                <span>
                  <el-button type="text" v-for="(item,index) in orderCompleteType" :key='index' @click="orderCompleteChange(item.id)" :style="{color:item.id==orderCompleteIndex?'#409EFE !important':'rgba(0,0,0,0.45) !important'}">{{item.value}}</el-button>
                </span>
                <span>
                    <el-date-picker
                      v-model="searchTime"
                    ...
                    <el-button plain @click="clearSearchInfo('order')" size="mini">重&nbsp;&nbsp;置</el-button>
                </span>
              </div>
            </div>
            <el-row>
              <el-col :span="15">
                <div class="echart-line" id="orderCompleteData" ref="orderCompleteData" style="width:95%;height: 320px;margin-left: 20px;margin-right: 10px;"></div>
              </el-col>
              <el-col :span="8" :offset="1">
                <el-table :data="flowerdata" style="width: 100%;margin-bottom:15px;" size="mini">
                  <el-table-column prop="top" label="排名">
                    <template slot-scope="scope">
                      <span v-if="scope.row.top <= 3" class="top top3">{{scope.row.top}}</span>
                      <span v-else class="top">{{scope.row.top}}</span>
                    </template>
                  </el-table-column>
                  <el-table-column prop="name" label="花型名称" :show-overflow-tooltip="true">
                  </el-table-column>
          ...
          <el-col :span="24" class="itemEchart">
            <div class="sellCountContentTitle">
              <div class="titleBox">
                <span>客户出货米数</span>
                <span>
                  <el-button type="text" v-for="(item,index) in orderCompleteType" :key='index' @click="customerOutChange(item.id)" :style="{color:item.id==customerOutIndex?'#409EFE !important':'rgba(0,0,0,0.45) !important'}">{{item.value}}</el-button>
                </span>
                <span>
                    <el-date-picker
                      v-model="searchTime"
                    ...
                    <el-button plain @click="clearSearchInfo('customer')" size="mini">重&nbsp;&nbsp;置</el-button>
                </span>
              </div>
            </div>
            <div class="echart-line" id="customerOutData" ref="customerOutData" style="width:95%;height: 350px;margin-left: 20px;margin-right: 10px;"></div>
          </el-col>
        </el-row>
        <el-row class="chartItem">
          <el-col :span="24" class="itemEchart">
            <div class="sellCountContentTitle">
              <div class="titleBox">
                <span>面料品类出货米数</span>
                <span>
                  <el-button type="text" v-for="(item,index) in orderCompleteType" :key='index' @click="fabricOutChange(item.id)" :style="{color:item.id==fabricOutIndex?'#409EFE !important':'rgba(0,0,0,0.45) !important'}">{{item.value}}</el-button>
                </span>
                <span>
                    <el-date-picker
                      v-model="searchTime"
                    ...
                    <el-button plain @click="clearSearchInfo('fabric')" size="mini">重&nbsp;&nbsp;置</el-button>
                </span>
              </div>
            </div>
            <div class="echart-line" id="fabricOutData" ref="fabricOutData" style="width:95%;height: 350px;margin-left: 20px;margin-right: 10px;"></div>
          </el-col>
        </el-row>
      </div>
    </div>
