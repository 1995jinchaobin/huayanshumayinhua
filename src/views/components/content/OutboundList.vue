  ...
  <div class="outboundList">
    ...
    <div class="contentTable">
      ...
      >
        ...
        <el-table-column prop="finishNum" label="已出库米数" align="center">
        </el-table-column>
            ...
            <div id="printChuKuArea">
              ...
              <div class="tbodyDayin">
                <div class="titleThDayin">
                  ...
                  <div class="n1 flexCenter borderR">货品名称</div>
                  <div class="n2 flexCenter borderR">规格型号</div>
                  <div class="n3 flexCenter borderR">花号</div>
                  <div class="n4 flexCenter borderR">类型</div>
                ...
                <div>
                  <div
                    ...
                    class="dayin"
                  >
                    <div class="n1 flexCenter borderTR">
                      {{ item.huopinName }}
                    </div>
...
export default {
  ...
  methods: {
    ...
    chuku (a) {
      ...
      this.chukuInfo = a
      this.huopinName = a.fabricName.split('-')[0]
      this.guigeType = a.fabricName.split('-')[1]
      const params = {
        id: a.id
      }
      this.$get('/inventory/out/detail/list', {
    ...
    async chukuBtn () {
      ...
      a.huopinName = this.huopinName
      a.guigeType = this.guigeType
    ...
    chukuSelectBtn () {
      ...
      this.$get('/order/print/' + this.fkOrderId, {
        ...
        this.chukuSelectVisible = false
        this.chukKuDialogVisible = true
        console.log(this.huopinName)
        console.log(this.guigeType)
      })
    },
    // 关闭明细抽屉
    closeMingXiDrawer () {
    ...
    handleSelectionChange (rows) {
      console.log(rows)
      rows.forEach(item => {
        item.huopinName = item.fabricName.split('-')[0]
        item.guigeType = item.fabricName.split('-')[1]
      })
      console.log(rows)
